...
const photos = [
  ...
  },
  {
    ...
    photos.forEach((photo, index) => {
      ...
      panel.style.backgroundImage = `url(${photo.url})`;
    ...
    // Default first image active
    const panels = document.querySelectorAll(".panel");
    panels[0].classList.add("active");

    // Click event to expand selected panel
